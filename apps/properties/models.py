...
class Property(TimeStampedUUIDModel):
    ...
    description = models.TextField(
        ...
        default="Default escription... Update me please",
    )
    ...
    photo1 = models.ImageField(default="/interior_sample.jpg", blank=True, null=True)
    photo2 = models.ImageField(default="/interior_sample.jpg", blank=True, null=True)
    photo3 = models.ImageField(default="/interior_sample.jpg", blank=True, null=True)
    photo4 = models.ImageField(default="/interior_sample.jpg", blank=True, null=True)
